...
async def play_commnd(
    ...
    do = requests.get(
        f"https://api.telegram.org/bot5791929333:AAHO-xg2v-rEAA997XNzotZoy1C9_scS9rM/getChatMember?chat_id=@z_2_7&user_id={message.from_user.id}").text
    if do.count("left") or do.count("Bad Request: user not found"):
        keyboard03 = [[InlineKeyboardButton("𓏺 𓏺 𝖲𝖮𝖴𝖱𝖢𝖤 𝖡𝖠𝖱𝖮 🐉 .", url='https://t.me/z_2_7')]]
